...
const LS_KEY = "mzparas_lux_booking_v3";
...
export default function App() {
  ...
  function book() {
    ...
    setErrorMsg("");
    setSuccessMsg("Appointment request received.");
    setCustomerName("");
    setCustomerPhone("");
    setCustomerNotes("");
    setSelectedTimeISO(null);
      ...
      <header className="sticky top-0 z-20 border-b bg-white/85 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <div className="hidden items-center gap-2 sm:flex">
            ...
            <Badge className="rounded-xl">Booking</Badge>
          </div>
        </div>
      </header>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-xs text-neutral-500">
                        SMS confirmation is built in and will deliver once Twilio campaign approval finishes.
                      </div>
                    </div>
                  </CardContent>
                </Card>
                            ...
                            >
                              <div className="flex items-start justify-between gap-3">
                                <div>
                                  ...
                                  {a.customer?.notes ? (
                                    <div className="mt-2 rounded-2xl bg-neutral-50 p-3 text-sm text-neutral-700">
                                      {a.customer.notes}
                                    </div>
                                  ) : null}
                                </div>
                    ...
                    {!adminAuthed ? (
                      ...
                      <>
                        <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-4 text-sm text-neutral-700">
                          ...
                          <div className="mt-1 text-xs text-neutral-600">Local storage demo • CSV export ready</div>
                        </div>
      ...
      <footer className="mx-auto max-w-6xl px-4 pb-10">
        <div className="mt-6 rounded-2xl border border-neutral-200 bg-white p-5 text-sm text-neutral-700">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div className="font-medium">Next upgrades</div>
            <Badge variant="secondary" className="rounded-xl">
              Deposits • SMS • Live website
            </Badge>
          </div>
